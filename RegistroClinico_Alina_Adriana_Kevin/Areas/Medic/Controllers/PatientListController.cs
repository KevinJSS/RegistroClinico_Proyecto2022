...
namespace RegistroClinico_Alina_Adriana_Kevin.Areas.Medic.Controllers
{
    ...
    public class PatientListController
    {
        ...
        public PatientListController(IUnitOfWork unitOfWork)
        {
        ...
        //{
        //    IEnumerable<PatientList> medicamentList = _unitOfWork.PatientList.GetAll();
        ...
        //{
        //    var patientList = _unitOfWork.PatientList.GetAll();
